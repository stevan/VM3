...
subtest '... testing 001-simple-labels', sub {
    my $src = $t->load_source('001-simple-labels');
...
subtest '... testing 002-complex-labels', sub {
    my $src = $t->load_source('002-complex-labels');
